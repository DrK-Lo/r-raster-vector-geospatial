...
what this data looks like. First we'll plot the DTM elevation data: (Suggest instructor shows class and have them follow along without coding, in the interest of time)
...
And then the DSM elevation data: (Suggest instructor shows class and have them follow along without coding, in the interest of time)
...
(Below: Suggest instructor runs code instead of challenge, in interest of time)
...
> ## Challenge: Explore the NEON San Joaquin Experimental Range Field Site (15-25 min)
> 
