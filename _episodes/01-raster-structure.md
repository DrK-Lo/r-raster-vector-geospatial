...
## 3701572", : downloaded length 2245237 != reported length 10507719
~~~
{: .error}
...
~~~
## Warning in download.file("https://ndownloader.figshare.com/files/
## 3701572", : URL 'https://s3-eu-west-1.amazonaws.com/pfigshare-u-files/
## 3701572/NEONDSMetTimeSeries.zip': status was 'Failure when receiving data
## from the peer'
~~~
{: .error}
...
~~~
## Error in download.file("https://ndownloader.figshare.com/files/3701572", : download from 'https://ndownloader.figshare.com/files/3701572' failed
~~~
{: .error}
...
~~~
Error in geom_spatial(data = RGB_2m_nas, aes(fill = band3), na.rm = FALSE): could not find function "geom_spatial"
~~~
{: .error}
...
~~~
Error in geom_spatial(data = DSM_HARV, aes(fill = band1)): could not find function "geom_spatial"
~~~
{: .error}
